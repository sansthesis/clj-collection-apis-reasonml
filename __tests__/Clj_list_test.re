    ...
    () => {
      ...
      describe(
        ...
        () => {
          test(
            "should return an empty list when given an empty list",
            () => expect([||] |> Clj_list.filter(even)) |> toEqual([||])
          );
          test(
            "should return an empty list when no elements match",
            () => expect([|1|] |> Clj_list.filter(even)) |> toEqual([||])
          );
          test(
            "should return an list with only elements that match",
            () => {
              expect([|2, 1, 3, 4|] |> Clj_list.filter(even))
              |> toEqual([|2, 4|])
              |> ignore;
              expect(
                [|"a", "b", "a", "c"|]
                |> Clj_list.filter((letter) => letter == "a")
              )
              |> toEqual([|"a", "a"|])
            }
          )
      ...
      describe(
        ...
        () => {
          ...
          test(
            ...
            () =>
              expect([|2, 1, 3, 4|] |> Clj_list.remove(even))
              |> toEqual([|1, 3|])
          )
        }
      );
      ...
      describe(
        ...
        () => {
          ...
          test(
            ...
            () =>
              expect([|1, 2, 3|] |> Clj_list.takeNth(1))
              |> toEqual([|1, 2, 3|])
          );
          test(
      ...
      describe(
        ...
        () => {
          ...
          test(
            ...
            () =>
              expect(
                [|1, 2, 4, 6, 8, 1, 3, 2, 3|] |> Clj_list.partitionBy(even)
              )
      ...
      describe(
        ...
        () => {
          ...
          test(
            ...
            () =>
              expect([|2, 4, 6, 8, 0|] |> Clj_list.every(even))
              |> toEqual(true)
          )
        }
      );
      ...
      describe(
        ...
        () => {
          ...
          test(
            ...
            () =>
              expect(Clj_list.repeatedly(5, dummy))
              |> toEqual([|7, 7, 7, 7, 7|])
          )
        }
      );
      ...
      describe(
        ...
        () => {
          ...
          test(
            ...
            () =>
              expect([|1, 2, 3, 1|] |> Clj_list.dedupe)
              |> toEqual([|1, 2, 3, 1|])
          );
          test(
